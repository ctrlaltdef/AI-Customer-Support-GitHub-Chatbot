      ...
      <div className={`md:w-1/2 w-full h-full bg-[#05001b] text-[#fff] flex flex-col border-t md:border-t-0 md:border-l ${border} p-8 md:p-20 justify-between items-center`}>
        <div className='w-full flex flex-col max-w-[400px]'>
          <div className='w-full flex flex-col mb-6'>
            ...
            <p className='text-base font-semibold mb-2 text-center'>Welcome back! Enter your details to sign in.</p>
          </div>
          ...
          <div className='w-full flex flex-col my-4'>
            <button onClick={handleSignIn} className={`w-full bg-[#fff] text-[#05001b] font-semibold rounded-md p-4 text-center flex items-center justify-center focus:outline-none hover:bg-opacity-90 transition-all`}>
              Sign In
            </button>
          </div>
